...
#EXCLUDE
exclude = ['sub-9042_ses-2_task-faces_run-1_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz',
 'sub-9065_ses-2_task-sleepiness_space-MNI152NLin2009cAsym_desc-brain_mask.nii.gz']
...
def loadAllMasks ():
    ...
    maskDF = maskDF[~maskDF['filename'].isin(exclude)]
    print("Masks loaded:", len(maskDF['path'].tolist()))
    maskDF.to_csv('masksLoadedDF.csv')
    return maskDF
...
finalMask.to_filename(saveDir + "final_resamp_intersected_mask_v2.nii.gz")
...
if savePlots == True:
    plt.savefig(saveDir + 'plots/masking/final_resamp_intersected_v2/sub-9001_ses-1_task-arrows_space-MNI152NLin2009cAsym_desc-preproc_original_bold.png')
    plt.close()
...
if savePlots == True:
    plt.savefig(saveDir + 'plots/masking/final_resamp_intersected_v2/sub-9001_ses-1_task-faces_space-MNI152NLin2009cAsym_desc-preproc_original_bold.png')
    plt.close()
...
if savePlots == True:
    plt.savefig(saveDir + 'plots/masking/final_resamp_intersected_v2/sub-9001_ses-1_task-hands_space-MNI152NLin2009cAsym_desc-preproc_original_bold.png')
    plt.close()
...
if savePlots == True:
    plt.savefig(saveDir + 'plots/masking/final_resamp_intersected_v2/sub-9001_ses-1_task-rest_space-MNI152NLin2009cAsym_desc-preproc_original_bold.png')
    plt.close()
...
if savePlots == True:
    plt.savefig(saveDir + 'plots/masking/final_resamp_intersected_v2/sub-9001_ses-1_task-sleepiness_space-MNI152NLin2009cAsym_desc-preproc_original_bold.png')
    plt.close()
