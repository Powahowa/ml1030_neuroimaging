...
dataDir = "/external/rprshnas01/netdata_kcni/edlab/temp_dataknights/masked_BOLD_images/stand-True_confounds-Masked"
...
def loadImages ():
    ...
    paths = list(pathlib.Path(dataDir).glob('**/func/*_space-MNI152NLin2009cAsym_desc-preproc_bold_masked_(final_resamp_intersected_v2)_bold.nii.gz'))
...
df = loadImages()
df.to_csv('imageDimensions-masked-v2.csv')
df.head()