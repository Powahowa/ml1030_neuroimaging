...
maskedDataPath = "/external/rprshnas01/netdata_kcni/edlab/temp_dataknights/masked_BOLD_images/stand=True_confounds=Included/"
pathSep = "/"
...
components_df.to_csv("components_df_2.csv")
...
def writeAppliedMasks (i):
    ...
    cropMask = NiftiMasker(mask_img="./finalMask/final_resamp_intersected_mask_v2.nii.gz", standardize=True)
